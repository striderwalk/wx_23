...
DataFilter
v2.0.1
(added functionality to offset all data points so that none are negative)
"""
...
class DataFilter:
    ...
    def offset(
        self, data: np.array, *, offset: int | float = 0, points: int = None
    ) -> np.array:
    ...
    def reset(self) -> None:
        ...
        self.settings = [
            {"select": True, "invert": False, "scale": 1, "offset": 0, "auto_offset": 0}
        ] * 40
